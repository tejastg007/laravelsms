                    ...
                    <table class="table table-borderless">
                        <tbody>
                            ...
                            <tr>
                                <td>total fee </td>
                                <td>:</td>
                                <td>{{ $data->course->course_fee + $data->course->registration_fee }} Rs</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="text-center" colspan="3">
                                    <a href="" class="btn btn-info">view course study material</a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                                        ...
                                        <table class="table table-borderless">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>total fee </td>
                                                    <td>:</td>
                                                    <td>{{ $course->registration_fee + $course->course_fee }} Rs</td>
                                                </tr>
                                                <tr>
                                                    <td>number of installments </td>
                                                    <td>:</td>
